  ...
  verticalLayout(
    ...
    wellPanel(
      div(class="header",
        ...
        p("AlignStat is fully described in ",a(href="http://bmcbioinformatics.biomedcentral.com/articles/10.1186/s12859-016-1300-6"," this paper"),". Please cite the paper if you use this tool in your research")
      )
    ),
